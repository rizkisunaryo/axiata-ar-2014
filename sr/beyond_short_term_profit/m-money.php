...
<div style="width:860px; margin:auto; padding:50px 50px;">
	<p>DIGITAL INCLUSION AND DIGITISED ECOSYSTEMS </p>
	<p><img src="../assets/img/c4/bstp_bottom1.png" width="85" height="105" alt=""/>retwerwe</p>
<div style="margin-top:20px;" class="title-orange" data-sr="enter bottom, move 20px">M-Money</div>
...
<div style="margin-top:10px;" class="justify" data-sr="enter bottom, move 20px">
In June 2012 Dialog launched eZ Cash. This mobile money service enables those with limited access to banking facilities, and even those with regular access to banking services, to use a mobile platform for a broad range of financial transactions. eZ Cash connects close to two million Sri Lankan mobile users with 16,500 merchants and service providers through the country’s largest mobile payment and transaction gateway. Within the first 12 months of launching eZ cash saw 330,000 transactions. By December 2014, eZ Cash had 1.6 million subscribers. For 2014 alone, the total transaction value conducted through the eZ Cash platform was SLR8.5 billion in 2014.</div>

<div style="margin-top:20px;" class="title-orange" data-sr="enter bottom, move 20px">eZ Cash</div>
<div style="margin-top:10px;" class="justify" data-sr="enter bottom, move 20px">
...
<div style="margin-top:20px;" class="title-orange" data-sr="enter bottom, move 20px">XL Tunai</div>
<div style="margin-top:10px;" class="justify" data-sr="enter bottom, move 20px">
XL Tunai is our mobile money service in Indonesia that allows customers to perform a range of financial transactions through their mobile phones. The service facilitates a variety of services including the purchase of credit towards their bills, payments to merchants, and cash transfers locally and globally. At the end of 2014 there were 1.3 million registered users and the total transaction volume for the year was 2.5 million. XL Tunai is guaranteed by Otoritas Jasa Keuangan the financial services authority Indonesia and this provides additional security to XL customers who wish to use this platform.</div>
</div>
</body>
</html>