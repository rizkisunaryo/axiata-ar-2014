		...
		<section id="keyHighlightsSection">
			<div style="width:960px; margin:0 auto; padding:55px; margin-top:90px; height:1400px; box-sizing:border-box; overflow:hidden;">
				<div style="margin-top:0px; line-height:1;">
					<span class="title grey8Color" style="font-size:25px;">Financial</span><br />
					<span class="title maroonColor" style="font-size:31px;">Highlights</span>
				</div>
              ...
              <div style="position:relative; margin-top:80px;">
                <div style="position:relative;">
                  <div style="position:relative; font-size:22px;" class="title">18.7</div>
                ...
                <div style="position:relative; margin-top:10px;">
                  ...
                  <div style="position:relative;" class="title">20%</div>
                </div>
                <div style="position:relative; margin-top:10px;">
              ...
              <div style="position:relative; left:100px;">
                ...
                <div class="graphRow1Year" style="position:relative;">
            ...
            <div style="position:relative; top:-80px;">
              ...
              <div style="position:relative; margin-top:80px;">
                <div style="position:relative;">
                  <div style="position:relative; font-size:22px;" class="title">2.3</div>
                  <div style="position:relative; font-size:14px; font-color:#808285;" class="title">billion</div>
                </div>
                <div style="position:relative; margin-top:10px;">
                  <div style="position:relative; background-image:url('../assets/img/chapter2/2/arrow-up2.png'); background-repeat:no-repeat; background-position:left top; width:36px; height:30px;"></div>
              ...
              <div style="position:relative; left:100px;">
                ...
                <div class="graphRow2Year" style="position:relative;">
                  <div class="graphYear" style="position:relative; top:-196px; left:-55px;">2010</div>
									<div class="graphYear" style="position:relative; top:-216px; left:0px;">2011</div>
									<div class="graphYear" style="position:relative; top:-235px; left:50px;">2012</div>
									<div class="graphYear" style="position:relative; top:-253px; left:105px;">2013</div>
            ...
            <div style="position:relative; top:-160px;">
              ...
              <div style="position:relative; margin-top:80px;">
                <div style="position:relative;">
                  <div style="position:relative; font-size:22px;" class="title">266</div>
              ...
              <div style="position:relative; left:100px;">
                ...
                <div class="graphRow3Year" style="position:relative;">
                  <div class="graphYear" style="position:relative; top:-196px; left:-55px;">2010</div>
									<div class="graphYear" style="position:relative; top:-216px; left:0px;">2011</div>
									<div class="graphYear" style="position:relative; top:-235px; left:50px;">2012</div>
									<div class="graphYear" style="position:relative; top:-253px; left:105px;">2013</div>
              ...
              <div style="position:relative; margin-top:80px;">
                <div style="position:relative;">
                  <div style="position:relative; font-size:22px;" class="title">60.5</div>
                  <div style="position:relative; font-size:14px; font-color:#808285;" class="title">billion</div>
                </div>
                <div style="position:relative; margin-top:10px;">
                  <div style="position:relative; background-image:url('../assets/img/chapter2/2/arrow-up2.png'); background-repeat:no-repeat; background-position:left top; width:36px; height:30px;"></div>
              ...
              <div style="position:relative; left:100px;">
                ...
                <div id="graph16" style="position:absolute; top:-6px; left:10px;"></div>
                <div id="graph17" style="position:absolute; top:-6px; left:62px;"></div>
                <div id="graph18" style="position:absolute; top:-6px; left:114px;"></div>
                <div id="graph19" style="position:absolute; top:-6px; left:166px;"></div>
                <div id="graph110" style="position:absolute; top:-6px; left:218px;"></div>
                <div class="graphRow1Year" style="position:relative; top:115px; left:32px;">
                  <div class="graphYear" style="position:relative; top:-196px; left:-55px;">2010</div>
									<div class="graphYear" style="position:relative; top:-216px; left:0px;">2011</div>
									<div class="graphYear" style="position:relative; top:-235px; left:50px;">2012</div>
									<div class="graphYear" style="position:relative; top:-253px; left:105px;">2013</div>
            ...
            <div style="position:relative; top:-80px;">
              ...
              <div style="position:relative; left:100px;">
                ...
                <div class="graphRow2Year" style="position:relative; top:115px; left:32px;">
                  <div class="graphYear" style="position:relative; top:-196px; left:-55px;">2010</div>
									<div class="graphYear" style="position:relative; top:-216px; left:0px;">2011</div>
									<div class="graphYear" style="position:relative; top:-235px; left:50px;">2012</div>
									<div class="graphYear" style="position:relative; top:-253px; left:105px;">2013</div>
            ...
            <div style="position:relative; top:-160px;">
              ...
              <div style="position:relative; margin-top:80px;">
                <div style="position:relative;">
                  <div style="position:relative; font-size:22px;" class="title">22</div>
              ...
              <div style="position:relative; left:100px;">
                ...
                <div class="graphRow3Year" style="position:relative; top:115px; left:32px;">
                  <div class="graphYear" style="position:relative; top:-196px; left:-55px;">2010</div>
									<div class="graphYear" style="position:relative; top:-216px; left:0px;">2011</div>
									<div class="graphYear" style="position:relative; top:-235px; left:50px;">2012</div>
									<div class="graphYear" style="position:relative; top:-253px; left:105px;">2013</div>
